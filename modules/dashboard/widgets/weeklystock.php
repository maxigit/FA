...
# This is a copy of weeklyaccount
# Should be dryed up ASAP.
class weeklystock
{
...
function week_of_month($date) {
	...
	function get_account_transaction($from, $to, &$rows, $type, $offset, $table) {
        ...
        // Hack for stock delivery. Delivery are post poned by a month
            $tran_date = "IF(amount > 0 
                           , ADDDATE(".$tran_date.", INTERVAL 1 MONTH)
                           , ".$tran_date."
                           )";
