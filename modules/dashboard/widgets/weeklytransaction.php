...
# Display gl account like weekaccount
# but display debit and credit in separate graph
# instead of current/previous year
...
function week_of_month($date) {
    ...
    function weeklytransaction($params='')
    {
	if (isset($params))
	{
	...
	function get_account_transaction($from, $to, &$rows, $type, $offset, $table) {
		...
		$basic_sql = "SELECT sum(abs(amount)) AS amount,".
			($this->by_month ?
