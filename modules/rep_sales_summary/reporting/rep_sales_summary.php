...
function getTransactions($category, $from, $to)
{
	...
	$sql = "SELECT ".TB_PREF."stock_master.category_id,
		...
		$sql .= " GROUP BY ".TB_PREF."stock_master.category_id, ".TB_PREF."stock_category.description, ".TB_PREF."stock_master.stock_id, ".TB_PREF."stock_master.description, ".TB_PREF."debtor_trans_details.unit_price 
		ORDER BY ".TB_PREF."stock_master.category_id,
			".TB_PREF."stock_master.stock_id, ".TB_PREF."debtor_trans_details.unit_price";
