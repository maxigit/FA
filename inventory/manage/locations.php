	...
	if ($input_error != 1) 
	{
    	if ($selected_id != -1) 
    	{
    		...
    		update_item_location($selected_id, $_POST['location_name'], $_POST['delivery_address'],
                                 $_POST['phone'], $_POST['phone2'], $_POST['order_weight'], $_POST['stock_weight'], $_POST['fax'], $_POST['email'], $_POST['contact'], $_POST['availability_date'], $_POST['availability_period']);	
...
$th = array(_("Location Code"), _("Location Name"), _("Address"), _("Phone"), _("Secondary Phone"), _("Order weight"), _("Stock wegiht"), _("Availability Date"), ("Availability Period"), "", "");
...
while ($myrow = db_fetch($result)) 
{
	...
	label_cell($myrow["availability_date"]);
	label_cell($myrow["availability_period"]);
...
if ($selected_id != -1) 
{
	//editing an existing Location
 	...
 	if ($Mode == 'Edit') {
		...
		$_POST['availability_date'] = $myrow["availability_date"];
		$_POST['availability_period'] = $myrow["availability_period"];
		$_POST['fax'] = $myrow["fax"];
...
date_row(_("Availability Date:"), 'availability_date', 32, 30, 0,0, 1001); // don't set a date by default
text_row_ex(_("Availability Period:"), 'availability_period', 11, 11);
