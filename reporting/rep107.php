...
function print_invoices()
{
	...
	for ($i = $from; $i <= $to; $i++)
	{
            ...
            if($ppd+$ppd_gst <> 0) {
                ...
                $rep->NewLine(1);
                $rep->TextCol(0,6, _("Discount : ") . number_format($ppd,$dec). _("  -  Net : ") . number_format($net-$ppd, $dec). "  -  VAT : " . number_format($tax-$ppd_gst, $dec));
                $rep->TextCol(3,6, _("          Amount due if discount taken"));
